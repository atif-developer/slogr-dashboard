    ...
    <div class="position-absolute p-2">
      <div class="card bg-light" style="width: 190px; height: 260px">
        <div class="card-body">
          ...
          <div class="">
            <label class="form-check-label" @click="clearLines" style="color: var(--primary_color); cursor: pointer"><i
                class="fa-solid fa-circle-xmark" style="color: var(--primary_color); margin-top: 5px"></i> Clear
              Connections</label>
            <label class="form-check-label" @click="zoomDeafault"
              style="color: var(--primary_color); cursor: pointer"><i
                class="fa-solid fa-down-left-and-up-right-to-center"
                style="color: var(--primary_color); margin-top: 5px"></i> Default View</label>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async handleToggleGroup(groupId, switchValue) {
      ...
      //   });
      // }
      // ALWAYS keep clusters visible
      let clusterLayers = ["clusters", "cluster-count", "unclustered-point"];
